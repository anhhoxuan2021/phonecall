                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" >Add Branch <span id="appt-name"></span></li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        <div class="subheader row">
                            <h1 class="subheader-title col-md-8 col-sm-12">
                                <i style="color: black" class='subheader-icon fas fa-calendar-check'></i>Add Branch<span id="b-name-text"></span>
                            </h1>
                            <div class="col-md-4 col-sm-12">
                                <div id="reset-branch" class="float-lg-right m_b10 colsm12"><button class="btn btn-success"><strong>Reset</strong></button></div>
                                <div class="float-lg-right m-r10 colsm12"><a href="branches_list.php"><button class="btn btn-success"><strong>Branches List</strong></button></a></div>
                            </div>
                        </div>
                            ...
                            if($btn_permission['branch']['is_add_edit']==""){ ?>
                                <div class="row m-t20">
                                    <div class="col-md-2 col-sm-12">
                                        <button class="btn btn-danger form-control" id="btn-add-branch" >Add Branch</button>
                                    </div>
                                </div>
                            <?php }
                            ?>

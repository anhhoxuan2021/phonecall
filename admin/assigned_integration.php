...
$_title = 'Welcome';
$_active_nav = 'Assigned Integration';
...
';
$_description = 'Assigned Integration';
...
$acl_info = $_SESSION['1wire']['acl']['assigned_integration'];
$is_add_edit ="Add";
require_once APP_PATH.'/php/check_permission.php';
$_assg_acl_permission = $checkPermission($acl_info,$is_add_edit);
...
if($btn_permission['assigned_integration']['view']!=""){
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" >Add Assigned Integration <span id="appt-name"></span></li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        <div class="subheader row">
                            <h1 class="subheader-title col-md-8 col-sm-12">
                                <i style="color: black" class='subheader-icon fas fa-calendar-check'></i>Add Assigned Integration<span id="b-name-text"></span>
                            </h1>
                            <div class="col-md-4 col-sm-12">
                                <div id="reset-asg-intg" class="float-lg-right m_b10 colsm12"><button class="btn btn-success"><strong>Reset</strong></button></div>
                                <div class="float-lg-right m-r10 colsm12"><a href="assigned_integration_list.php"><button class="btn btn-success"><strong>Assigned Integration List</strong></button></a></div>
                            </div>
                        </div>
                        
                        <div class="container" style="padding-right: 0;padding-left: 0;">
                            <?php require_once APP_PATH.'/php/body_asg_intg.php'; ?>
                            <?php
                            if($btn_permission['assigned_integration']['is_add_edit'] ==""){ ?>
                                <div class="row m-t20">
                                    <div class="col-md-3 col-sm-12">
                                        <button class="btn btn-danger form-control" id="btn-asg-intg">Add Assigned Integration</button>
                                    </div>
                                </div>
                           <?php }
                            ?>
        ...
        <script type="text/javascript">
            var ai_password_bool ='<?=$_SESSION['1wire']['acl']['assigned_integration']['ai_password']['add'];?>';
        ...
        <script src="<?= APP_URL; ?>/js/ass_integration/asg_intg.js" type="text/javascript"></script>

...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div id="reset-group" class="float-lg-right m_b10 colsm12"><button class="btn btn-success"><strong>Reset</strong></button></div>
                                <div class="float-lg-right m-r10 colsm12"><a href="group_list.php"><button class="btn btn-success"><strong>Groups List</strong></button></a></div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            var is_addedit='<?php echo $_SESSION['1wire']['acl']['groups']['u_id']['add'];?>';
        </script>
